...
<br>
I removed almost all the code relating to myself in this repo, so you can make your own website using my template. I kept my code for my guestbook https://isopodheaven.com/guestbook.html but removed all assocaitons to my website, you would need to create your own database and add your connections. https://www.php.net/manual/en/mysqli.quickstart.connections.php. If you dont want to do that, you can just delete any file with the word guestbook in it.
